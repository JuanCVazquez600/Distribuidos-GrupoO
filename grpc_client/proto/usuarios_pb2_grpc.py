...
class UsuarioServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CrearUsuario = channel.unary_unary(
                ...
                response_deserializer=usuarios__pb2.Respuesta.FromString,
        ...
        self.ListarUsuarios = channel.unary_unary(
                ...
                response_deserializer=usuarios__pb2.UsuariosResponse.FromString,
                _registered_method=True)
        self.BajaUsuario = channel.unary_unary(
                '/usuarios.UsuarioService/BajaUsuario',
                request_serializer=usuarios__pb2.UsuarioIdRequest.SerializeToString,
                response_deserializer=usuarios__pb2.Respuesta.FromString,
                _registered_method=True)
...
def add_UsuarioServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CrearUsuario': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=usuarios__pb2.Respuesta.SerializeToString,
            ),
            ...
            'ListarUsuarios': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=usuarios__pb2.UsuariosResponse.SerializeToString,
            ),
            'BajaUsuario': grpc.unary_unary_rpc_method_handler(
                    servicer.BajaUsuario,
                    request_deserializer=usuarios__pb2.UsuarioIdRequest.FromString,
                    response_serializer=usuarios__pb2.Respuesta.SerializeToString,
            ),
...
class UsuarioService(object):
    ...
    def CrearUsuario(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            usuarios__pb2.Respuesta.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def ListarUsuarios(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            usuarios__pb2.UsuariosResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def BajaUsuario(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/usuarios.UsuarioService/BajaUsuario',
            usuarios__pb2.UsuarioIdRequest.SerializeToString,
            usuarios__pb2.Respuesta.FromString,
            options,
            channel_credentials,
            insecure,
